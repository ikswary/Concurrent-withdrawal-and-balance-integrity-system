...
#### 2. 락 타임아웃으로 인한 정합성 위험

**문제**

락 획득 후 비즈니스 로직이 락의 타임아웃을 넘어서는 경우 일관성이 보장되지 않을 가능성이 존재

**대응 방안**

비즈니스 로직에 타임아웃을 설정한다거나, 트랜잭션 커밋 직전에 락 유효성을 재확인하는 등의 절차를 추가하여 락 유효시간 내에 모든 비즈니스 로직의 완료를 보장하는 방향으로 해결해나가야할것으로 생각됩니다
